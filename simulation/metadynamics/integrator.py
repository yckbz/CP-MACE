...
class NoseHoover(MolecularDynamics):
    ...
    def step(self):
        ...
        self.Vne[1] = self.Vne[0] + (self.targetmu - self.atoms.get_calculator().calc.get_mu()) * self.delT / 2 / self.Mne
        ...
        self.Vne[2] = self.Vne[1] + (self.targetmu - self.atoms.get_calculator().calc.get_mu()) * self.delT / 2 / self.Mne
