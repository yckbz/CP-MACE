...
def configure_model(
    ...
    output_args = {
        ...
        "potential": args.compute_potential,
    ...
    # Build model
    if model_foundation is not None and args.model in ["MACE", "FermiMACE", "FermiMACE_uncertainty", "FermiMACE_2", "FermiMACE_evidential", "ScaleShiftMACE"]:
    ...
    if args.model == "FermiMACE":
        ...
        return modules.ScaleShiftMACE(
            **model_config,
            ...
            mean_potential=args.mean_potential,
            mean_electron=args.mean_electron,
            radial_MLP=ast.literal_eval(args.radial_MLP),
            radial_type=args.radial_type,
            heads=heads,
        )
    if args.model == "FermiMACE_evidential":
        if args.interaction_first not in [
            "RealAgnosticInteractionBlock",
            "RealAgnosticDensityInteractionBlock",
        ]:
        ...
        return modules.ScaleShiftMACE(
            **model_config,
            ...
            radial_type=args.radial_type,
            heads=heads,
            pred_evidential=True,
        )

    if args.model == "FermiMACE_uncertainty":
        if args.interaction_first not in [
            "RealAgnosticInteractionBlock",
            "RealAgnosticDensityInteractionBlock",
        ]:
        ...
        return modules.ScaleShiftMACE(
            **model_config,
            ...
            radial_type=args.radial_type,
            heads=heads,
            pred_uncertainty=True,
        )
    if args.model == "FermiMACE_2":
        if args.interaction_first not in [
            "RealAgnosticInteractionBlock",
            "RealAgnosticDensityInteractionBlock",
        ]:
