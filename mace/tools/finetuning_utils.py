...
def load_foundations_elements(
    ...
    """
    model.state_dict()["mean_electron"].copy_(model_foundations.mean_electron.clone())
    ...
    if model_foundations.electron_input:
        num_species_foundations_old = num_species_foundations
    ...
    if model_foundations.electron_input:
        indices_weights_old = indices_weights.copy()  
        indices_weights.append(num_species_foundations - 1)
        indices_weights_new = indices_weights.copy()    
        indices_weights = indices_weights_old   
