...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "MACE",
            "FermiMACE",
            "FermiMACE_uncertainty",
            "FermiMACE_evidential",
            "FermiMACE_2",
            "ScaleShiftMACE",
            "ScaleShiftBOTNet",
            "AtomicDipolesMACE",
    ...
    parser.add_argument(
        "--empty_potential_value",
        help="the value of empty potential",
        type=float,
        default=-10000.,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "weighted",
            "fermi_weighted",
            "fermi_weighted_evidential",
            "fermi_weighted_uncertainty",
            "forces_only",
            "virials",
            "stress",
            "dipole",
    ...
    parser.add_argument(
        "--potential_weight", help="weight of energy loss", type=float, default=1.0
    )
    parser.add_argument(
        "--swa_energy_weight",
...
def build_preprocess_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.05,
        help="SGHMC friction term C (0–1)"
    )
    parser.add_argument(
        "--burn_in", 
        type=int, 
        default=3000,
        help="SGHMC burn‑in steps before sampling"
    )
    parser.add_argument(
        "--sample_interval", 
        type=int, 
        default=100,
        help="Parameter updates between posterior samples"
    )
    parser.add_argument(
        "--max_samples", 
        type=int, 
        default=500,
        help="Total posterior samples to keep"
    )
