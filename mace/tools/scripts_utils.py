...
def extract_config_mace_model(model: torch.nn.Module) -> Dict[str, Any]:
    ...
    config = {
        "electron_input": model.electron_input,
        "potential_output": model.potential_output,
...
def get_loss_fn(
    ...
    elif args.loss == "fermi_weighted":
        loss_fn = modules.FermiWeightedEnergyForcesLoss(
            energy_weight=args.energy_weight, forces_weight=args.forces_weight, potential_weight=args.potential_weight
        )
    elif args.loss == "fermi_weighted_evidential":
        loss_fn = modules.FermiWeightedEnergyForcesLossEvidential(
            energy_weight=args.energy_weight, forces_weight=args.forces_weight, potential_weight=args.potential_weight
        )
    elif args.loss == "fermi_weighted_uncertainty":
        loss_fn = modules.FermiWeightedEnergyForcesLossUncertainty(
            energy_weight=args.energy_weight, forces_weight=args.forces_weight, potential_weight=args.potential_weight
        )
